...
In the architecture, you can configure your infrastructure using the followings,
  ...
  - The Launch Template should be configured to;
    ...
    - Download the "Blog-Page-App-Django-on-AWS-Environment" folder from Github repository,

    - Install the requirements using requirements.txt in `Blog-Page-App-Django-on-AWS-Environment' folder
    ...
    - Instance launched should be tagged `Blog-Page-App-Django-on-AWS-Environment`
...
- Step 5: Download or clone project definition from `gokhanwell` repo on Github 
