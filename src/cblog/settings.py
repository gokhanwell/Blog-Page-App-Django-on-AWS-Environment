...
DATABASES = {
    'default': {
        ...
        'HOST': 'blog-page-rds.cbhki4mjpwkh.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogpagegokhanyardimci' # please enter your s3 bucket name
